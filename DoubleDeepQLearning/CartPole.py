...
def main(args):
    ...
    # Files names:
    plot_rewards_file =  "results/CartPole_rewards_per_episode_best"
    model_filename = "data/model_cartpole_best"
    ...
    if(args.train):
        ...
        if(args.algorithm == 1):
            ...
            DDQN =   DoubleDeepQLearning(env, gamma, epsilon, epsilon_min, epsilon_dec, episodes, batch_size, memory, model,max_steps,target,100)
            rewards = DDQN.train()
            # Grafico de rewards
